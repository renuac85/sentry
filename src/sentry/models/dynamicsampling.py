...
class CustomDynamicSamplingRule(Model):
    ...
    def sanitize_relocation_json(
        ...
        # Sanitized to identical, but valid, values.
        sanitizer.set_string(
            json, SanitizableField(model_name, "condition"), lambda _: '{"op":"and","inner":[]}'
        )
        sanitizer.set_string(json, SanitizableField(model_name, "condition_hash"))
        sanitizer.set_string(
            json, SanitizableField(model_name, "query"), lambda _: "event.type:transaction"
        )
